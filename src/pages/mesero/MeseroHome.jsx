...
export default function MeseroHome() {
  ...
  return (
    ...
    >
      ...
      {/* Botón flotante */}
      <button
        className="fixed bottom-24 sm:bottom-6 cursor-pointer right-6 w-14 h-14 rounded-full flex items-center justify-center text-white text-2xl font-bold z-20 active:scale-95 transition-transform duration-150"
        style={{
